...
// Number of floors
#define N_FLOORS 4
// Number of signals and lamps on a per-floor basis (excl sensor) OBS!!!FLYTTET FRA C-FIL
#define N_BUTTONS 3
...
*/
void elev_set_floor_indicator(int floor); //SLÅR PÅ DEN DU SETTER, SLÅR AV RESTEN
